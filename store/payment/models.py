...
class OrderProduct(models.Model):
    ...
    @property  # декоратор нужен что-бы вызывать метод в другой модели
    def get_total_price(self):
        # метод для получения суммы товара в его кол-во
...
class SaveOrderProduct(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = 'История заказанных продукт'
